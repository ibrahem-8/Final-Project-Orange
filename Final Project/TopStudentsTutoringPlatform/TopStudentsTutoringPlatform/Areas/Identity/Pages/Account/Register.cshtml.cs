...
namespace TopStudentsTutoringPlatform.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                ModelState.AddModelError("Input.Role", "Please select a valid account type.");
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                if (Input.ProfileImageFile != null && Input.ProfileImageFile.Length > 0)
                {
                    ...
                    var extension = Path.GetExtension(Input.ProfileImageFile.FileName).ToLower();

                    if (!allowedExtensions.Contains(extension))
                    {
                        ModelState.AddModelError("Input.ProfileImageFile", "Only JPG, JPEG, PNG, and WEBP images are allowed.");
                        return Page();
                    }
